...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
#BSP: modify RABHLYSP-1 by cheng.cheng3 20181128 start
CUSTOM_BUILD_VERNO = CY-RA8-H613-U
#BSP: modify RABHLYSP-1 by cheng.cheng3 20181128 end
...
#ITD: Add Sensor Drv Of X5516 By Jie.liu 20181022 Start
...
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw gc8034_mipi_raw gc8034ext2_mipi_raw gc6133_serial_yuv
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3l6_17201505 gc8034_17201483 gc8034_17201552 gc6133_17201539
CUSTOM_HAL_LENS = dw9718saf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = gc6133_serial_yuv
...
#ITD: Add Sensor Drv Of X5516 By Jie.liu 20181022 End
CUSTOM_HIFI_SENSORS = no
#BSP: add RABHLYSP-12 by changliang.guo 20181204 start
...
#BSP: add RABHLYSP-12 by changliang.guo 20181204 end
...
#ITD: Add Sensor Drv Of X5516 By Jie.liu 20181022 Start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw gc8034_mipi_raw gc8034ext2_mipi_raw gc6133_serial_yuv
...
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc6133_serial_yuv
...
#TSD:modified RABHLYSP-2 by guangzhou.luo 20181120 start
CUSTOM_MODEM=ra8_h613
#TSD:modified RABHLYSP-2 by guangzhou.luo 20181120 end
...
#BSP:Modified XWWYLHLYS-13 by lichen 20181203 start
#BSP:Modified XWWYLHLYS-13 by lichen 20181203 end
MNTL_SUPPORT = no
...
# modify RABHLYSP-10  by yong.guo 20181129 start
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
# modify RABHLYSP-10  by yong.guo 20181129 end
...
#SID1: add KBEHLYS-9 by shenjiang.he 18.08.30 start
MTK_BUILD_VERNO=RA8-H613U-P-RU-191015V196
FINGERPRINT_BUILD_VERNO=U-RU-191015V196
#SID1: add KBEHLYS-9 by shenjiang.he 18.08.30 end
MTK_BWC_SUPPORT = yes
#TSD: modify RABHLYSP-2 by guangzhou.luo 20181130 start
MTK_C2K_LTE_MODE = 0
#TSD: modify RABHLYSP-2 by guangzhou.luo 20181130 end
...
#ITD:modify ITDTEAM-1493 by shoufeng.zhao for close MTK HDR 20190115 start
MTK_CAM_HDR_SUPPORT = no
#ITD:modify ITDTEAM-1493 by shoufeng.zhao for close MTK HDR 20190115 end
#[ITD] add for thirdpart apk by desuo.lu 20190122 start
TRAN_CAMERA_THIRDPART = yes
#[ITD] add for thirdpart apk by desuo.lu 20190122 end
...
#BSP:add RABHLYSP-13 by yongxian.wang 20181128 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:add RABHLYSP-13 by yongxian.wang 20181128 end
MTK_DUAL_DISPLAY_SUPPORT = 0
# modify RABHLYSP-10  by yong.guo 20181128 start
MTK_DUAL_MIC_SUPPORT = no
# modify RABHLYSP-10  by yong.guo 20181128 end
...
#TSD: modify RABHLYSP-416  by jiangerji 20190109 start
MTK_ETWS_SUPPORT = yes
#TSD: modify RABHLYSP-416  by jiangerji 20190109 end
...
# BSP : modify RABHLYSP-9 by di.qian 20181127 start
MTK_FACTORY_MODE_IN_GB2312 = no
#BSP : modify RABHLYSP-9 by di.qian 20181127 end
...
MTK_FIRST_MD = 1
#TSD: modified RABHLYSP-2 by guangzhou.luo 20181130 start
MTK_FLIGHT_MODE_POWER_OFF_MD = yes
#TSD: modified RABHLYSP-2 by guangzhou.luo 20181130 end
MTK_FLIGHT_MODE_POWER_OFF_MD_POLICY = 0
MTK_FLV_PLAYBACK_SUPPORT = yes
#TSD: modify RABHLYSP-14 by sihai.jia 20181129 start
MTK_FMRADIO_APP = yes
#TSD: modify RABHLYSP-14 by sihai.jia 20181129 end
...
# modify by xiaodong.ren for disable WAPI 20171020 start
MTK_WAPI_SUPPORT = no
# modify by xiaodong.ren for disable WAPI 20171020 end
...
#TCD: modify RABHLYSP-999 by mengmeng.zhang5 20190122 start
MTK_WMA_PLAYBACK_SUPPORT = no
#TCD: modify RABHLYSP-999 mengmeng.zhang5 20190122 end
...
#SID1: add KBEHLYS-9 by shenjiang.he 18.09.06 start
MTK_DURASPEED_SUPPORT = no
#SID1: add KBEHLYS-9 by shenjiang.he 18.09.06 end
...
#BSP:add RABHLYSP-5 by baofu.zhang for brightness permission 20181126 start
TRAN_LCM_SUPPORT = yes
#BSP:add RABHLYSP-5 by baofu.zhang for brightness permission 20181126 end

#BSP:add RABHLYSP-8 by wang.qin 20181127 start
TRAN_FT_CUSTOM_PERMISSION_SUPPORT = yes
TRAN_FT_RESET = yes
TRAN_FT_REBOOT = yes
TRAN_FT_CUSTOM_SHELL = yes
TRAN_FT_BENCHFLAG_SUPPORT = yes
#BSP:add RABHLYSP-8 by wang.qin 20181127 end
#BSP: add custom macro by chencheng3 20181126 start
CUSTOM_TRAN_PROJECT=tran_ra8
CUSTOM_TRAN_BOM=tran_ra8_u1
#BSP: add custom macro by chencheng3 20181126 end
...
CUSTOM_TRAN_PCBA = tran_pcba_h613
#ITD:modify RABHLYSP-11 by quan.chang 181127 end
# modify RABHLYSP-10  by yong.guo 20181128 start
TRAN_AUDIOTEST_SUPPORT = yes
# modify RABHLYSP-10  by yong.guo 20181128 end

#BSP:add XLELHLES-7 by shentao.yang enable tranfs tkv f2fs WP persist cache for ra8s 20181129 start
TRAN_USE_CUSTOM_FS = yes
TRAN_TKV_SUPPORTED=yes
TRAN_USE_F2FS = yes
#BSP:add XLELHLES-7 by shentao.yang enable tranfs tkv f2fs WP persist cache for ra8s 20181129 end

#SID1: add KBEHLYS-9 by shenjiang.he 18.08.30 start
include $(LOCAL_PATH)/ProjectConfig_SID.mk
#SID1: add KBEHLYS-9 by shenjiang.he 18.08.30 end

#TDD: add RABHLYSP-15 zixuan.lian 20181129 start
include $(LOCAL_PATH)/ProjectConfig_TDD.mk
include $(LOCAL_PATH)/ProjectConfig_PPD.mk
#TDD: add RABHLYSP-15 zixuan.lian 20181129 end

#APP add RABHLYSP-364 xing.wang 20190102 start
include $(LOCAL_PATH)/ProjectConfig_APP.mk
#APP add RABHLYSP-364 xing.wang 20190102 end

#[ITD]add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20181204 start
TRAN_CAMERA_FEATURE = yes
#[ITD]add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20181204 end
#ITD:modify KBQJHLYW-140  by yang.li3 20190213 start
TRAN_CAMERA_FLASHLIGHT_SCREEN_WITH_LED = yes
#ITD:modify KBQJHLYW-140  by yang.li3 20190213 end
#BSP: modify RABHLYSP-4 by zhengbo.tang 20181205 start
TRAN_TP_SUPPORT = yes
#BSP: modify RABHLYSP-4 by zhengbo.tang 20181205 end
#ITD:add RABHLYSP-959 by desuo.lu 20190122 start
TRAN_FLASH_SLIDE_CONTROL=yes
#ITD:add RABHLYSP-959 by desuo.lu 20190122 end

#TDD:add by kai.pan 2019.02.28 start
include $(LOCAL_PATH)/ProjectConfig_CDD.mk
#TDD:add by kai.pan 2019.02.28 end
